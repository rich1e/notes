...
![[assets/Chronicle/2024/IPATool 使用/IMG-20260629163136071.png]]
...
![[assets/Chronicle/2024/IPATool 使用/IMG-20260629163136071-32.png]]

`2FA` **表示双重认证**，这个错误表示需要验证码，双重认证未通过。

> request failed: failed to unmarshal json: invalid character '<' looking for beginning of value

![[assets/Chronicle/2024/IPATool 使用/IMG-20260629163136072.png]]

这个错误估计是搜索的**关键词不对，找不到结果**。修改一下关键词即可。

![[assets/Chronicle/2024/IPATool 使用/IMG-20260629163136072-94.png]]

> license is required

![[assets/Chronicle/2024/IPATool 使用/IMG-20260629163136072-95.png]]
...
![[assets/Chronicle/2024/IPATool 使用/IMG-20260629163136072-96.png]]
