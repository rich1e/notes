...
- [[buckets/work-records/vscode-vim-text-object]] — 文本对象（与 surround 配合使用）
- [[buckets/work-records/vscode-vim-fold]] — 代码折叠（使用了 vim-surround）
- [[buckets/work-records/vscode-vim-indent-object]] — 缩进对象（使用了 vim-surround）
