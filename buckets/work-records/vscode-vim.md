...
- [[buckets/work-records/vscode-vim-navigation]] — 窗口导航与分屏
- [[buckets/work-records/vscode-vim-search]] — 搜索命令
- [[buckets/work-records/vscode-vim-easymotion]] — EasyMotion 快速跳转
- [[buckets/work-records/vscode-vim-sneak]] — Sneak 双字符跳转
- [[buckets/work-records/vscode-vim-surround]] — Surround 成对符号编辑
- [[buckets/work-records/vscode-vim-text-object]] — 文本对象
- [[buckets/work-records/vscode-vim-indent-object]] — 缩进对象
- [[buckets/work-records/vscode-vim-fold]] — 代码折叠
- [[buckets/work-records/vscode-vim-replace]] — 替换模式
- [[buckets/work-records/vscode-vim-multicursor]] — 多光标
- [[buckets/work-records/vscode-markdown]] — VSCode Markdown 插件