...
![[assets/buckets/work-records/windows-settings/IMG-20260629163136416.png]]
...
- [[buckets/work-records/mac-tips]] — Mac 环境设置（对比参考）
- [[buckets/work-records/shell-scripts]] — Shell 脚本（含 PowerShell 示例）
