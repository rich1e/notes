---
title: NEOGEO
source: https://jjui.readthedocs.io/mame/mame_configure/neogeo.html
author:
published:
created: 2026-04-30
description:
...
> 家用机游戏，如果使用模拟器的存档功能， 你可能需要设置一下存档位置， 不然，这一款游戏机里，所有的游戏都用同一个位置，挺麻烦。
> 
...
> > 
> > 注意和 全局 mame.ini 相同的选项，都删除，仅保留不同的选项。 此处仅设置了 bios 一项，那仅保留这一项就行了，其它的都删了。
...
> > > 官方原版 MAME ，没有这个 bios 。
> > 
> > 早期版本的 MamePlus 没有 bug 无所谓用哪个 bios ； 后期版本的 MamePlus 如果遇到 bug ，就使用 uni-bios 切换到 AES.
...
> [http://unibios.free.fr/](http://unibios.free.fr/)
> 
> [http://unibios.free.fr/howitworks.html](http://unibios.free.fr/howitworks.html)
...
- [NDS用的街机游戏NEO GEO全集打包下载](https://bbs.3dmgame.com/thread-6471345-1-1.html)
- [接近完美！ DS平台SNK街机游戏模拟器横空出世！](https://www.emsky.net/bbs/forum.php?mod=viewthread&tid=28176)
- [NDS上的NeoGeo模拟器NeoDS | Demon's Blog](https://demon.tw/software/nds-neogeo-emulator-neods.html)
- [NDS掌机 街机游戏NEO GEO模拟全集 下载 - 围炉Go](https://www.wlgooo.com/66142.html)
- [【精品】NDS用NEOGEO模拟器NeoDS(接近完美)](http://bbs.chinaemu.org/read-htm-tid-81003-uid-294.html)
- [Falkor/wii-custom-config: A customized configuration for my Wii, based on Homebrew Channel apps](https://github.com/Falkor/wii-custom-config)
- [NEOGEO](https://jjui.readthedocs.io/mame/mame_configure/neogeo.html)
- [适合新版mame的neogeo bios - HighWayToHell](https://blog.druggo.org/post/2010/01/11/%E9%80%82%E5%90%88%E6%96%B0%E7%89%88mame%E7%9A%84neogeo-bios)
- [NEO-GEO 搞定！一个BIOS搞定一切，或者双BIOS！现在你有选择了！ 还有核心套装更新:) : r/miniSNESmods](https://www.reddit.com/r/miniSNESmods/comments/8l6txc/neogeo_fixed_one_bios_to_rule_them_all_or_dual/?tl=zh-hans)
- [neoDS - 更新！|GBAtemp.net - 独立电子游戏社区 --- neoDS - Update! | GBAtemp.net - The Independent Video Game Community](https://gbatemp.net/threads/neods-update.374204/)
- [Yardape8000/NeoDS: NDS NeoGeo Emulator (updated from 2.0 source)](https://github.com/Yardape8000/NeoDS)