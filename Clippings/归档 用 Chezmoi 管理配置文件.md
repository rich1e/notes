...
source: https://axionl.me/p/%E5%BD%92%E6%A1%A3-%E7%94%A8-chezmoi-%E7%AE%A1%E7%90%86%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6/#gnome-keyring
author:
published: 2021-01-29
created: 2026-07-25
description: 前言 项目地址：twpayne/chezmoi 早前看了 Farseerfc 老师这篇译文，开始用 Stow 打理自己家目录中的配置文件，其实现非常简单直接：在一个特定的目录
tags:
  - clippings
  - chezmoi
  - dotfiles
...
> [https://www.chezmoi.io/docs/install/](https://www.chezmoi.io/docs/install/)
...
![[assets/Clippings/归档 用 Chezmoi 管理配置文件/IMG-20260725100609557.png|doctor]]
...
![[assets/Clippings/归档 用 Chezmoi 管理配置文件/IMG-20260725100609565.png|dot_gitconfig.tmpl]]
...
![[assets/Clippings/归档 用 Chezmoi 管理配置文件/IMG-20260725100609570.png|加密内容]]

加密内容

![[assets/Clippings/归档 用 Chezmoi 管理配置文件/IMG-20260725100609575.png|解密内容]]
...
![[assets/Clippings/归档 用 Chezmoi 管理配置文件/IMG-20260725100609580.png|Seahorse 是一个管理 gnome-keyring 的软件]]
...
KeepassXC 支持自定义字段，比如你的密钥： ![[assets/Clippings/归档 用 Chezmoi 管理配置文件/IMG-20260725100609584.png|KeepassXC Entry Attributes]]
